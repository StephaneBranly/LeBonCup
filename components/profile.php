    ...
    function profile($user){
        ...
        if (count($res) != 0)
        {
            ...
            else
            {
                ...
                <h2>Moyens de contact</h2>
                <div id='contact_tel' onclick=\"change_content('contact_tel','$res[phone]');\"><i class='icon-phone'></i>voir le numéro</div>
                <div id='contact_mail' onclick=\"change_content('contact_mail','$res[email]');\"><i class='icon-at'></i>voir l'email</div>
